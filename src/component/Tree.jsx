...
export default class Tree extends Component {
    ...
    handlerComponent() {
        ...
        const checkTrees = $.fn.zTree.getZTreeObj(this.componentId).getCheckedNodes("true");
        _.each(this.props.dataSource,(data)=>{
            const checkNode = _.find(checkTrees,(checkTree)=>{
                return checkTree.id == data.id;
            });
            if(checkNode){
                data.checked = true;
            }
    ...
    setChecked(treeObject, node) {
        if (node.checked) {
            treeObject.checkNode(node, true, false);
        }
    ...
    getCheckJson() {
        return {
            check: {
                ...
                chkboxType: this.props.checkboxType,
                chkStyle: "checkbox",
